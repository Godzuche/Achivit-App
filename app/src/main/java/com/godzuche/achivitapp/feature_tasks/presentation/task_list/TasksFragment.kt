package com.godzuche.achivitapp.feature_tasks.presentation.task_list
...
import com.godzuche.achivitapp.feature_tasks.presentation.task_list.util.*
            ...
            setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    R.id.action_settings -> {
                        ...
                        val action = TasksFragmentDirections.actionGlobalSettingsFragment()
                        findNavController().navigate(action)
                        true
                    }
                    R.id.action_filter -> {
                        val action = TasksFragmentDirections.actionGlobalFilterBottomSheetDialog()
                        findNavController().navigate(action)
                        true
                    }
                    R.id.action_search -> {
...
//                                        Log.d("Chip", "Collected chip id: $it")
        ...
        binding.chipAddCategory.setOnClickListener { chipAddCategoryView ->
            val action = TasksFragmentDirections.actionGlobalAddCategoryCollectionFragment(
