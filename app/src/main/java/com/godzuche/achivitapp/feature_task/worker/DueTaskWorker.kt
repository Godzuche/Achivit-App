...
class DueTaskWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        val workDeferred = CoroutineScope(Dispatchers.Default).async {
            ...
            this@DueTaskWorker.applicationContext.startForegroundService(
                taskId,
                task.await().title,
        ...
        setForeground(
            ForegroundInfo(
                ...
                NotificationCompat.Builder(this,
                    com.godzuche.achivitapp.feature_task.receivers.Constants.NOTIFICATION_CHANNEL_ID)
                    .setSmallIcon(R.drawable.ic_baseline_check_box_24)
                    .setContentTitle(com.godzuche.achivitapp.feature_task.receivers.Constants.NOTIFICATION_TITLE)
